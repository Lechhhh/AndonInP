...
class Line {
    ...
    change(event,data,user,view) {
        ...
        if(event==='actionOK') {
            ...
            if(s.shiftActive||s.assemblyShiftActive)throw new PublicError('ACTIVE_SHIFT','Zmiana już trwa. Zatrzymaj ją przed rozpoczęciem nowej.',409);
